...
if (isset($_POST['submit'])) {
    ...
    try {
        ...
        // Insert the user-warehouse relationship into the Warehouse_by_user table
        $sql3 = "INSERT INTO Warehouse_by_user (user_id, Warehouse_ID) VALUES ($user_id, $warehouse_id)";
        if (!mysqli_query($conn, $sql3)) {
            throw new Exception("Error inserting user warehouse: " . mysqli_error($conn));
        }        
    ...
    <div class="S-main-content">
	 ...
	 <?php // displaying the alert
            ...
            <form method="post"> 
                ...
                <!-- Part 5 -->
                <div class="form-group row">
                <label for="inputRole" class="col-sm-1 col-form-label"><span class="S-required">* </span>Select Warehouse:</label>
                    <div class="col-sm-3">
                        <select class="form-control" name="Warehouse_ID" id="inputRole" required>
