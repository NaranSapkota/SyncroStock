...
// SQL Orders
$sql = "SELECT o.*, s.Supplier_ID,s.Company_Name, s.Contact_Name, s.Address, s.Phone, s.Email, w.Warehouse_Name,w.Warehouse_ID, u.username
        FROM orders o
        JOIN Suppliers s ON o.Supplier_ID = s.Supplier_ID
        JOIN Warehouses w ON o.Warehouse_ID = w.Warehouse_ID
        JOIN user u ON o.User_ID_Responsable = u.user_ID
        WHERE o.Order_Number='$OrderNum'";

// SQL details_orders
$sql2 = "SELECT o.*, p.Product_Name
        FROM details_orders o
...
$ContactSupplier = $row['Contact_Name'];
$AddressSupplier = $row['Address'];
$PhoneSupplier = $row['Phone'];
$EmailSupplier = $row['Email'];
$WhDelivery = $row['Warehouse_Name'];
$WhDeliveryID = $row['Warehouse_ID'];
...
<div class="S-container">
    ...
    <div class="S-main-content">
        <div>
            ...
            <form id="addItemForm" action="./receive_order_run.php" method="POST" enctype="multipart/form-data" onsubmit="return confirmSubmit()"> 

                <!-- Parte 1: Nombre -->
                <div class="form-group row py-4">
                    <div class="col-sm-2">
                        <img src="../../images/Home1.png" alt="Transactions">
                    </div>
                    <div class="col-sm-2">
                        <h2><?php echo $OrderNum; ?></h2>
                        <?php 
                            echo "Order Date: ". $Date."<br>"; 
                            echo "Order Created by: ". $Responsable; 
                        ?>
                    </div>

                    <div class="col-sm-2">
                        <h2><?php echo "Delivery"; ?></h2>
                        <?php 
                            echo "Delivery In: ". $WhDelivery."<br>"; 
                    ...
                    <div class="col-sm-2">
                        ...
                        <?php 
                            ...
                            echo "Contact Name: ". $ContactSupplier."<br>"; 
                            echo "Address: ". $AddressSupplier."<br>"; 
                            echo "Phone: ". $PhoneSupplier."<br>"; 
                            echo "Email: ". $EmailSupplier."<br>";        
                        ?>
                    </div>
                    ...
                    <?php
                        if ($result2->num_rows > 0) {
                            ...
                            while ($row2 = $result2->fetch_assoc()) {
                                ...
                                echo "<input type='hidden' name='Transaction' value='PO'>";
                                echo "<input type='hidden' name='orderNum' value='$OrderNum'>";
                                echo "<input type='hidden' name='today' value='$today'>";
				echo "<input type='hidden' name='Supplier' value='$SupplierID'>";
    ...
    toggleSaveButton();
        ...
        function confirmSubmit() {
            if (confirm("¿Are you sure you can complete and close the purchase order?")) {
